...
public class MainView<T extends JComponent & UriGettable> implements UriOpenable, PreferencesChangeListener {
    ...
    public MainView(
        ...
        invokeLater(() -> {
            ...
            Action jdWebSiteAction = newAction("Decomp-Java Website", browser, "Open decomp-java Web site", jdWebSiteActionListener);
            Action jdGuiIssuesActionAction = newAction("Decomp-Java issues", browser, "Open decomp-java issues page", jdGuiIssuesActionListener);
            Action jdCoreIssuesActionAction = newAction("Decomp-java-Core issues", browser, "Open JD-Core issues page", jdCoreIssuesActionListener);
